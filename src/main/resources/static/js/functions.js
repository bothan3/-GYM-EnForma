...
// El nodo recibido es SPAN
	if (editando == false) {
		...
		var apellido2 = nodosEnTr[3].textContent; var sexo = nodosEnTr[4].textContent;
		var nuevoCodigoHtml = 	
		'<td><input type="text" name="id" id="id" value="'+id+'" size="10" readonly="readonly"></td>'+	
		'<td><input type="text" name="nombre" id="nombre" value="'+nombre+'" size="10"></td>'+
		'<td><input type="text" name="apellido1" id="apellido1" value="'+apellido1+'" size="5"</td>'+
		'<td><input type="text" name="apellido2" id="apellido2" value="'+apellido2+'" size="5"</td>'+
		'<td><input type="text" name="sexo" id="sexo" value="'+sexo+'" size="5"</td>'+
		'<td>En edición</td>';
		nodoTr.innerHTML = nuevoCodigoHtml;
		nodoContenedorForm.innerHTML = 
		'<td><p>TEST:'+entidad+' </p></td>'+	
...
function capturarEnvio(entidad){
	...
	'<input type="hidden" name="sexo" value="'+document.querySelector('#sexo').value+'">'+
